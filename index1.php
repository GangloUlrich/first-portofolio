...
<body>
		...
		<div class="container-fluid ctn-a  col-12 " style="z-index:-1;">
		...
		<div class="container-fluid p-4" id="about">
			...
			<p class="cl-p text-justified">Phasellus vestibulum lorem sed risus ultricies tristique nulla. Magna ac placerat vestibulum lectus mauris ultrices eros in cursus. Augue mauris augue neque gravida in fermentum et sollicitudin ac. Ornare aenean euismod  Orci eu lobortis elementum nibh. Tristique magna sit amet purus gravida quis blandit. Suspendisse sed nisi lacus sed viverra tellus in hac habitasse. Placerat in egestas erat imperdiet sed euismod nisi.</p>
		...
		<div class="container-fluid pt-4 ctn-c">
							  ...
							  <div class="carousel-inner">
							    ...
							    <div class="carousel-item">
										  ...
										  <div class="d-flex flex-column flex-md-row justify-content-around">
												  	...
												  	<div class="text-justified p-md-4">
												  		<h5>Smart Kids Academy</h5>
												  		<h6 class="text-yellow">2020-present,Abomey-calavi,Bénin</h6>
												  		<p>UX/UI Designer</p>
												  	</div>
	...
	<div class="container-fluid p-4 mt-5" id="skills">
							...
							<div class="col-md-6 col-sm-12 ">
										<h4 class="text-center">Chatbot Builder</h4>
												...
												<div class="d-flex flex-md-row justify-content-center ">
									 				...
									 				<div class=" text-gray"><img class="img-fluid" src="img/bot.png"/></div>
		...
		<div class="container-fluid" id="contact">
			...
			<div class="row">
						...
						<div class="col-md-6 col-sm-12 bg-n p-3">
								...
								<h3 class="text-yellow text-center"> INFORMATIONS UTILES</h3>
									...
									<div class=" col-sm-12 d-flex flex-row justify-content-end mt-5 align-items-center p-md-5 if-c">
										...
										<div class="pl-3" >
											<p class="text-white text-left">(+229) 98432641/61166339</p>
			...
			<div class="d-flex flex-row justify-content-end">
							...
							<a class="text-white" href="https://twitter.com/GangloUlrich" target="_blank"><i class="fa fa-twitter-square ic-c2"></i></a>
			</div>

			<p class="text-center mt-3">©2020. Ulrich GANGLO. All rights reserved</p>
										...
										$("#form").validate(
											{
												...
												messages : {
													...
													name:{
														required:"veuiller entrer votre nom"
													},
													...
													contact: {
														required:"vauillez remplir ce champ"
													}
